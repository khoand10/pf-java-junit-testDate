...
class NextDayCalculatorTest {
    ...
    /*@Test
    @Disabled("Test 28/2/2018 = 1/3/2018")
    void testFeb() {
        String tomorow = NextDayCalculator.NextDayCaculator(28,02,2018);
        System.out.println(tomorow);
        assertEquals("1/3/2018",tomorow);
    }

    @Test
    @Disabled("Test 29/2/2016")
    void testFeb2(){
        String tomorow = NextDayCalculator.NextDayCaculator(29,02,2016);
        System.out.println(tomorow);
        assertEquals("1/3/2016",tomorow);
    }

    @Test
    @Disabled("Test 30/06 = 1/7/2018")
    void testJun(){
        String tomorow = NextDayCalculator.NextDayCaculator(30,06,2018);
        System.out.println(tomorow);
        assertEquals("1/7/2018",tomorow);
    }

    @Test
    @Disabled("Test 31/01 = 02/02/2018")
    void testJan(){
        String tomorow = NextDayCalculator.NextDayCaculator(31,01,2018);
        System.out.println(tomorow);
        assertEquals("02/02/2018",tomorow);
    }

    @Test
    @Disabled("Test 31/12/2018 = 1/1/2019")
    void testYear(){
        String tomorow = NextDayCalculator.NextDayCaculator(31,12,2018);
        System.out.println(tomorow);
        assertEquals("1/1/2019",tomorow);
    }*/
}